...
//		   var fullBarcode = "(01)"+gs1code+"(17)"+expireIn+"(10)"+lineNumIn+"(21)"+serialNumIn;
		...
		//		alert("바코드가 생성되었습니다.");    
		    ...
		    $('#goLabel').click(function(){
			    ...
			    //바코드생성하는 메서드로 ㄱㄱ
		   	var fullBarcode = "01"+gs1code+"17"+expireIn+"10"+lineNumIn+"21"+serialNumIn;
			//	$('#generateForm').attr('action','${pageContext.request.contextPath}/print?gs1code='+gs1code+'&expireIn='+expireIn+"&lineNumIn="+lineNumIn+'&serialNumIn='+serialNumIn);
				
			    alert(fullBarcode);
			    
// 		    var allData = { "gs1code": gs1code, "expireIn": expireIn,"lineNumIn":lineNumIn,"serialNumIn":serialNumIn  };
